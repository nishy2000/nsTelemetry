...
ECHO -----------------------
dotnet.exe build -c Release --no-incremental --no-dependencies nsTelemetry.csproj
...
dotnet.exe pack -c Release --no-build -o "%WORK_FOLDER%" nsTelemetry.csproj
IF ERRORLEVEL 1 GOTO ERROR
